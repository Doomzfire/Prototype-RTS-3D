...
2. Tag the release commit (example: `git tag v0.1.2` then `git push origin v0.1.2`).
3. Create a GitHub Release for `v0.1.2` and use `docs/PATCH_NOTES.md` as the release notes body.
