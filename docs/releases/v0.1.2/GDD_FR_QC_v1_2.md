...
**Moteur:** Godot 4.6  
**Langage:** GDScript  
**Version du jeu:** v0.1.2 (Prototype jouable)  
**Dernière mise à jour:** 2026-02-17 (America/Montreal)
...
## 7) Unités 3D + Animations (v0.1.2)
### Statut
- Première unité 3D animée intégrée : **GoldKeeper**
- Lecture d’animation **Idle/Walk** selon la vitesse (prototype)

### Standard animation (cible v0.2.0)
- Idle, Walk, Attack, Death (noms normalisés)
